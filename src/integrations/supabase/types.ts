...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      create_missing_fk_indexes: { Args: never; Returns: undefined }
      debug_user_access: {
      ...
      fix_auth_uid_policies: { Args: never; Returns: undefined }
      ...
      update_auth_settings: { Args: { config: Json }; Returns: Json }
